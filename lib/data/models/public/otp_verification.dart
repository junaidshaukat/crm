...
class Data {
  ...
  Data({this.tagNumber, this.organizationTag, this.firstName, this.lastName, this.email, this.language, this.token, this.tokenType, this.tokenValidity, this.organizations});
