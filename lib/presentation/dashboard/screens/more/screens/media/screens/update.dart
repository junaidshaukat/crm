...
class UpdateMediaScreen extends StatefulWidget {
  ...
  @override
  State<UpdateMediaScreen> createState() => _UpdateMediaScreenState();
}

class _UpdateMediaScreenState extends State<UpdateMediaScreen> {
