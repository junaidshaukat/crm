...
class SigninController extends GetxController {
  ...
  TextEditingController emailController = TextEditingController(text:emailText);
  TextEditingController passwordController = TextEditingController(text: passwordText);
